Изначальный скрипт был написан в марте 2022 года при заиствовании кода из различных ответов со StackOverflow. При загрузке на GitHub, скрипт был дополнен минимальной языковой поддержкой (английский и русский языки).
